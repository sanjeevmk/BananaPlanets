...
var ServerInformation = {
	POIDATA_SERVER: "http://www.sanjeevmk.in/bananaplanets/planetdata",
...
//		World.markerDrawable_idle = new AR.Model("assets/mars.wt3",{ scale: {x:0.2, y:0.2, z:0.2}  });
//		World.markerDrawable_selected = new AR.Model("assets/mars.wt3", { scale: {x:0.042, y:0.042, z:0.042} });
		World.markerDrawable_directionIndicator = new AR.ImageResource("assets/indi.png");

		// loop through POI-information and create an AR.GeoObject (=Marker) per POI
		for (var currentPlaceNr = 0; currentPlaceNr < poiData.length; currentPlaceNr++) {
    World.markerDrawable_idle = new AR.ImageResource(poiData[currentPlaceNr].model);
		World.markerDrawable_selected = new AR.ImageResource(poiData[currentPlaceNr].model);
		...
		var singlePoi = {
				...
				"model": World.markerDrawable_idle,
				"scale": parseFloat(poiData[currentPlaceNr].scale)
//				"model": World.markerDrawable_idle
			}
